        ...
        <el-form ref="typeform" :model="fenleiItem" :rules="fenleirules" label-width='120px'>
            ...
            <el-form-item size = 'small' label = '图片'>
                <el-upload
                    ...
                    :auto-upload="false">
                    <img style="width:50%;" v-if="fenleiItem.file" :src="typeof(fenleiItem.file) == 'string'?(imgSrc+fenleiItem.file.replace('url(','').replace(')','').trim()):URL.createObjectURL(fenleiItem.file.raw)" class="avatar">
                    <div v-else >
