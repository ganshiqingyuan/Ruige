	...
	function b() {
		var f = {
			...
			build: function(i) {
				...
				var h = "<div class='dialog'>" + "<div>" + this.dialogs.message.replace("{{message}}", i.message);
				if(i.type === "confirm" || i.type === "prompt") {
			...
			notify: function(j, h, i) {
				var k = this.setupLogContainer();
				var g = document.createElement("div");
				g.className = (h || "default");
				if(f.logTemplateMethod) {
					g.innerHTML = f.logTemplateMethod(j)
				} else {
					g.innerHTML = j
				}
			...
			setup: function(l) {
				...
				k.className = "alertify hide";
				k.innerHTML = this.build(l);
				var j = k.querySelector(".ok");
				var m = k.querySelector(".cancel");
				var h = k.querySelector("input");
				var i = k.querySelector("label");
				if(h) {
					if(typeof this.promptPlaceholder === "string") {
						if(i) {
							i.textContent = this.promptPlaceholder
						} else {
				...
				function g(o) {
					...
					if(m) {
						m.addEventListener("click", function(p) {
							if(l.onCancel && "function" === typeof l.onCancel) {
								l.onCancel(p)
							}
							o({
		...
		return {
			...
			alert: function(h, g, i) {
				return f.dialog(h, "alert", g, i) || this
			},
			confirm: function(h, g, i) {
				return f.dialog(h, "confirm", g, i) || this
			},
			prompt: function(h, g, i) {
				return f.dialog(h, "prompt", g, i) || this
			},
			log: function(h, g) {
				f.log(h, "default", g);
				return this
